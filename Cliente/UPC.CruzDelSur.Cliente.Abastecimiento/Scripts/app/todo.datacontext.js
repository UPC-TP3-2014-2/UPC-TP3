...
window.todoApp.datacontext = (function () {
    ...
    function getTodoLists(todoListsObservable, errorObservable) {
        ...
        function getFailed() {
            errorObservable("Error al recuperar listas de tareas pendientes.");
        }
    }
    ...
    function saveNewTodoItem(todoItem) {
        ...
        return ajaxRequest("post", todoItemUrl(), todoItem)
            ...
            .fail(function () {
                todoItem.errorMessage("Error al agregar una nueva tarea pendiente.");
            });
    }
    function saveNewTodoList(todoList) {
        ...
        return ajaxRequest("post", todoListUrl(), todoList)
            ...
            .fail(function () {
                todoList.errorMessage("Error al agregar una nueva lista de tareas pendientes.");
            });
    }
    function deleteTodoItem(todoItem) {
        return ajaxRequest("delete", todoItemUrl(todoItem.todoItemId))
            .fail(function () {
                todoItem.errorMessage("Error al quitar una tarea pendiente.");
            });
    }
    function deleteTodoList(todoList) {
        return ajaxRequest("delete", todoListUrl(todoList.todoListId))
            .fail(function () {
                todoList.errorMessage("Error al quitar una lista de tareas pendientes.");
            });
    }
    function saveChangedTodoItem(todoItem) {
        ...
        return ajaxRequest("put", todoItemUrl(todoItem.todoItemId), todoItem, "text")
            .fail(function () {
                todoItem.errorMessage("Error al actualizar una tarea pendiente.");
            });
    }
    function saveChangedTodoList(todoList) {
        ...
        return ajaxRequest("put", todoListUrl(todoList.todoListId), todoList, "text")
            .fail(function () {
                todoList.errorMessage("Error al actualizar el título de la lista de tareas pendientes. Asegúrese de que no esté vacío.");
            });
    }
