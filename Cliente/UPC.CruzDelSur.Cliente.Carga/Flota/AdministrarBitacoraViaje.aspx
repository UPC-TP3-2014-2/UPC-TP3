<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdministrarBitacoraViaje.aspx.cs" Inherits="CRUZDELSUR.UI.Web.Flota.AdministrarBitacoraViaje1" %>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">    
                                                 <ContentTemplate>
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                                    GridLines="None"
                                                                    PageSize="8"
                                                                    Height="100%" width = "100%" CssClass="tbempleado" EmptyDataText="NO RECORD FOUND" 
                                                                    AllowPaging="True">
                                                                    <Columns>  
