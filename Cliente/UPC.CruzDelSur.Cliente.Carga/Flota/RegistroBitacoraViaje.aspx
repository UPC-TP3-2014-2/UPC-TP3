...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type ="text/javascript" >
        ...
        function confirmar() {
            ...
            msj = "¿Esta seguro(a) que desea registrar?";
...
<tr>
    ...
    <td><asp:Button ID="btnBuscarRuta" runat="server" Text="Buscar" Width="80px" onclick="btnBuscar_Click" />
     </td>
     <td>Ruta
     </td>
     <td>
...
<asp:Panel ID="pnlIncidencia" GroupingText="Incidencia" runat="server">
    ...
    <tr>
        <td>Evento</td>
        <td>
             <asp:DropDownList ID="ddltipoIncidencia" runat="server" Width="150px">
             </asp:DropDownList>
         </td>
         <td>
     ...
     <tr>
         ...
         <td>Descripción</td>
         <td>
         <asp:TextBox ID="txtDescripcion" runat="server" TextMode="MultiLine" Width="250" Height="50px"></asp:TextBox></td>
     </tr>
     </table>
                   ...
                   <table style="width:100%;text-align:center;">
                         <tr>
                             <td valign="top" align="center"  >
                                 <asp:Panel ID="pnlGrillaIncidentes" runat="server">
                                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">    
                                                 <ContentTemplate>
                                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                                    ...
                                                                    AllowPaging="True">
                                                                    <Columns>  
                                                                    <asp:BoundField DataField="fechaPartida" HeaderText="Fecha" Visible="true">
                                                                    ...
                                                                    <asp:BoundField DataField="tipoIncidencia" HeaderText="Evento" HeaderStyle-BackColor="#0070C0">
                    ...
                    <td>
                        <asp:Button ID="btnGuardar" runat="server" Text="Guardar" 
                            OnClientClick="confirmar();" onclick="btnGuardar_Click" /> 
