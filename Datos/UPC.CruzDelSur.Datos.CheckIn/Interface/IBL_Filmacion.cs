...
namespace UPC.CruzDelSur.Datos.CheckIn.Interface
{
    public interface IBL_Filmacion
    {
        ...
        int f_RegistrarFilmacion(string codBus, string MinGrab, string rutaVideo, string estado);
        int f_ActualizarFilmacion(string SolFilmacion, string MinGrab, string rutaVideo, string estado);
    }
}
