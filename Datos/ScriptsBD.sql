...
GO
/****** Object:  StoredProcedure [dbo].[SP_ACTUALIZARFILMACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS 
BEGIN
UPDATE TA_SOLICITUDFILMACION SET ESTADO=@ESTADO,INICIO_GRABACION = @INI_GRAB, FINAL_GRABACION=@FIN_GRAB,RUTA_VIDEO=@RUTA_VIDEO WHERE INT_SOLICITUD = @INT_SOL_FILM
END

GO
/****** Object:  StoredProcedure [dbo].[SP_ASIENTOSVEHICULO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BOLETOACTUALIZARASIENTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BOLETOCANCELARCHECKIN]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BOLETOCHECKIN]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BOLETOCONSULTAR]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BOLETOCONSULTARRECLAMO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BUSCACLIENTEXDNI]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_BUSCAUTILXCODIGO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CONSULTARFILMACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_ELIMINARCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_ELIMINARPAGO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_ELIMINARPRODUCTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_EQUIPAJEACTUALIZAR]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_EQUIPAJEACTUALIZARESTADO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_EQUIPAJECONSULTAR]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_EQUIPAJEVERIFICAR]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
"ESTADO_VERIFICACION" = 
CASE 
         WHEN eq.DTE_FECHAVERIFICACION  IS NULL THEN 'Sin verificacion'
         WHEN eq.DTE_FECHAVERIFICACION  IS NOT NULL THEN 'Verificacion realizada - ' +convert(varchar,eq.DTE_FECHAVERIFICACION, 120)
...
GO
/****** Object:  StoredProcedure [dbo].[SP_EQUIPAJEVERIFICARESTADO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GENERARCODIGOCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GENERARREPORTE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[SP_GENERARREPORTE]
@INT_CODIGO_AGENCIA_SALIDA  INT,
@INT_CODIGO_AGENCIA_ORIGEN INT,
@VCH_ESTADOPAGO VARCHAR(20),
@VCH_ESTADO VARCHAR(20),
@DTM_FECHA_ORIGEN DATETIME,
@DTM_FECHA_DESTINO DATETIME
AS
...
WHERE AO.INT_CODIGO_AGENCIA=@INT_CODIGO_AGENCIA_ORIGEN AND
	  AD.INT_CODIGO_AGENCIA=@INT_CODIGO_AGENCIA_SALIDA AND
	  A.VCH_ESTADO=@VCH_ESTADO AND
	  A.VCH_ESTADOPAGO=@VCH_ESTADOPAGO AND
	  B.DTM_FECHA_ORIGEN=@DTM_FECHA_ORIGEN AND
	  b.DTM_FECHA_DESTINO=@DTM_FECHA_DESTINO

GO
/****** Object:  StoredProcedure [dbo].[SP_GENERARREPORTEDETALLE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_INSERTARCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_INSERTARDETALLECARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_INSERTARFILMACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTACARGAENTREGADA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTACARGASXFILTROS]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTADETALLECARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARAGENCIA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARCLIENTE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARPRODUCTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARPROGRAMACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARUNOCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARUNOCLIENTE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARUNOPRODUCTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTARUNOPROGRAMACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAUTIL]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_OBTENERPAGOXCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_RECLAMO_REGISTRAR]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_TIKETCONSULTAR]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_VALIDAUSUARIO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[__MigrationHistory]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[AuditEntry]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_AGENCIA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_ALMACEN]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_AREA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_AREAS]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_ASIENTOVEHICULO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_BOLETO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_CAPACITACIONES]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_CARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_CARGOS]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_CLIENTE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_DET_SOLICITUDCOCINA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_DET_SOLICITUDINSUMO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_DETALLECARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_DETALLEGUIAREMISION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_DETALLESHOJAVIDA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_EDUCACIONES]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_EQUIPAJE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_ESTADOASIENTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_EVALUACION_DESEMPENO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_EVALUACIONESDESEMPENO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_EXPERIENCIASLABORALES]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_FICHA_MOVIMIENTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_GUIAREMISION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_INSUMO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_PASAJERO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_PERSONA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_PERSONAS]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_PRODUCTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_PRODUCTO_CABINA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_PROGRAMACION_RUTA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_RECLAMO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_REFRIGERIO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_ROL]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_RUTA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_SOLICITUDCOCINA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_SOLICITUDES]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_SOLICITUDESCAPACITACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_SOLICITUDESPERSONAL]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_SOLICITUDFILMACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_SOLICITUDINSUMO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_SOLPRODUCTODECABINA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_STOCK]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_TIPO_CARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_TIPO_MOVIMIENTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_TIPO_PAGO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_TIPO_SERVICIO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_TIPO_TRANSPORTE]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_TIPOETIQUETA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_TIPOSDOCUMENTO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_TIPOSEDUCACION]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TA_TIPOSOLICITUD]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_TRAZABILIDADCARGA]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_UBIGEO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_USUARIO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TA_VEHICULO]    Script Date: 18/09/2014 08:15:58 p.m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
SET IDENTITY_INSERT [dbo].[TA_AGENCIA] ON 

INSERT [dbo].[TA_AGENCIA] ([INT_CODIGO_AGENCIA], [VCH_NOMBRE], [VCH_DIRECCION], [VCH_UBIGEO_DIRECCION]) VALUES (3, N'Lima', N'Av Las flores 345', N'010101')
INSERT [dbo].[TA_AGENCIA] ([INT_CODIGO_AGENCIA], [VCH_NOMBRE], [VCH_DIRECCION], [VCH_UBIGEO_DIRECCION]) VALUES (4, N'Piura', N'Av Los Alcanfores', N'010101')
INSERT [dbo].[TA_AGENCIA] ([INT_CODIGO_AGENCIA], [VCH_NOMBRE], [VCH_DIRECCION], [VCH_UBIGEO_DIRECCION]) VALUES (5, N'Ica', N'Av Las Cantuarias', N'010101')
INSERT [dbo].[TA_AGENCIA] ([INT_CODIGO_AGENCIA], [VCH_NOMBRE], [VCH_DIRECCION], [VCH_UBIGEO_DIRECCION]) VALUES (6, N'Arequipa', N'Av Arequipa', N'010101')
INSERT [dbo].[TA_AGENCIA] ([INT_CODIGO_AGENCIA], [VCH_NOMBRE], [VCH_DIRECCION], [VCH_UBIGEO_DIRECCION]) VALUES (7, N'Tacna', N'Av Tacna 765', N'010101')
SET IDENTITY_INSERT [dbo].[TA_AGENCIA] OFF
SET IDENTITY_INSERT [dbo].[TA_CARGA] ON 

INSERT [dbo].[TA_CARGA] ([INT_CODIGO_CARGA], [VCH_FICHA], [DTM_FECHA_REGISTRO], [VCH_REMITENTE], [VCH_DESTINATARIO], [DBL_PESOTOTAL], [DBL_IMPORTETOTAL], [DBL_IGV], [DBL_TOTAL], [VCH_OBSERVACION], [VCH_CLAVE_SEGURIDAD], [INT_TIPO_PAGO], [INT_CODIGO_PROGRAMACION_RUTA], [VCH_CLIENTE_ORIGEN], [VCH_ESTADOPAGO], [VCH_CLIENTE_DESTINO], [VCH_ESTADO]) VALUES (2, N'F000002', CAST(0x0000A3A800000000 AS DateTime), N'Jonathan Vidal Ore', N'Monica Landeo Aroni', CAST(8.00 AS Decimal(8, 2)), CAST(170.00 AS Decimal(8, 2)), CAST(30.60 AS Decimal(8, 2)), CAST(200.60 AS Decimal(8, 2)), N'hgf', N'MQAyADMA', NULL, 8, N'42770822', N'Cancelado', N'42770855', N'Entregado')
INSERT [dbo].[TA_CARGA] ([INT_CODIGO_CARGA], [VCH_FICHA], [DTM_FECHA_REGISTRO], [VCH_REMITENTE], [VCH_DESTINATARIO], [DBL_PESOTOTAL], [DBL_IMPORTETOTAL], [DBL_IGV], [DBL_TOTAL], [VCH_OBSERVACION], [VCH_CLAVE_SEGURIDAD], [INT_TIPO_PAGO], [INT_CODIGO_PROGRAMACION_RUTA], [VCH_CLIENTE_ORIGEN], [VCH_ESTADOPAGO], [VCH_CLIENTE_DESTINO], [VCH_ESTADO]) VALUES (3, N'F000003', CAST(0x0000A3A800000000 AS DateTime), N'Jonathan Vidal Ore', N'Jesus Amador Paiva Dominguez', CAST(6.00 AS Decimal(8, 2)), CAST(61.00 AS Decimal(8, 2)), CAST(11.00 AS Decimal(8, 2)), CAST(72.00 AS Decimal(8, 2)), N'hjkh', N'MQAyADMA', NULL, 8, N'42770822', N'Cancelado', N'42770846', N'Anulado')
INSERT [dbo].[TA_CARGA] ([INT_CODIGO_CARGA], [VCH_FICHA], [DTM_FECHA_REGISTRO], [VCH_REMITENTE], [VCH_DESTINATARIO], [DBL_PESOTOTAL], [DBL_IMPORTETOTAL], [DBL_IGV], [DBL_TOTAL], [VCH_OBSERVACION], [VCH_CLAVE_SEGURIDAD], [INT_TIPO_PAGO], [INT_CODIGO_PROGRAMACION_RUTA], [VCH_CLIENTE_ORIGEN], [VCH_ESTADOPAGO], [VCH_CLIENTE_DESTINO], [VCH_ESTADO]) VALUES (4, N'F000004', CAST(0x0000A3A800000000 AS DateTime), N'Jonathan Vidal Ore', N'Jesus Amador Paiva Dominguez', CAST(6.00 AS Decimal(8, 2)), CAST(112.50 AS Decimal(8, 2)), CAST(20.25 AS Decimal(8, 2)), CAST(132.75 AS Decimal(8, 2)), N'jhghj', N'MQAyADMA', NULL, 8, N'42770822', N'Cancelado', N'42770846', N'Registrado')
INSERT [dbo].[TA_CARGA] ([INT_CODIGO_CARGA], [VCH_FICHA], [DTM_FECHA_REGISTRO], [VCH_REMITENTE], [VCH_DESTINATARIO], [DBL_PESOTOTAL], [DBL_IMPORTETOTAL], [DBL_IGV], [DBL_TOTAL], [VCH_OBSERVACION], [VCH_CLAVE_SEGURIDAD], [INT_TIPO_PAGO], [INT_CODIGO_PROGRAMACION_RUTA], [VCH_CLIENTE_ORIGEN], [VCH_ESTADOPAGO], [VCH_CLIENTE_DESTINO], [VCH_ESTADO]) VALUES (5, N'F000005', CAST(0x0000A3A800000000 AS DateTime), N'Jonathan Vidal Ore', N'Jesus Amador Paiva Dominguez', CAST(30.00 AS Decimal(8, 2)), CAST(143.00 AS Decimal(8, 2)), CAST(25.74 AS Decimal(8, 2)), CAST(168.74 AS Decimal(8, 2)), N'weee', N'MQAyADMA', NULL, 9, N'42770822', N'Cancelado', N'42770846', N'Registrado')
INSERT [dbo].[TA_CARGA] ([INT_CODIGO_CARGA], [VCH_FICHA], [DTM_FECHA_REGISTRO], [VCH_REMITENTE], [VCH_DESTINATARIO], [DBL_PESOTOTAL], [DBL_IMPORTETOTAL], [DBL_IGV], [DBL_TOTAL], [VCH_OBSERVACION], [VCH_CLAVE_SEGURIDAD], [INT_TIPO_PAGO], [INT_CODIGO_PROGRAMACION_RUTA], [VCH_CLIENTE_ORIGEN], [VCH_ESTADOPAGO], [VCH_CLIENTE_DESTINO], [VCH_ESTADO]) VALUES (6, N'F000006', CAST(0x0000A3A900000000 AS DateTime), N'Jonathan Vidal Ore', N'Jesus Amador Paiva Dominguez', CAST(10.00 AS Decimal(8, 2)), CAST(312.50 AS Decimal(8, 2)), CAST(56.25 AS Decimal(8, 2)), CAST(368.75 AS Decimal(8, 2)), N'KJHJK', N'MQAyADMA', NULL, 8, N'42770822', N'Cancelado', N'42770846', N'Registrado')
INSERT [dbo].[TA_CARGA] ([INT_CODIGO_CARGA], [VCH_FICHA], [DTM_FECHA_REGISTRO], [VCH_REMITENTE], [VCH_DESTINATARIO], [DBL_PESOTOTAL], [DBL_IMPORTETOTAL], [DBL_IGV], [DBL_TOTAL], [VCH_OBSERVACION], [VCH_CLAVE_SEGURIDAD], [INT_TIPO_PAGO], [INT_CODIGO_PROGRAMACION_RUTA], [VCH_CLIENTE_ORIGEN], [VCH_ESTADOPAGO], [VCH_CLIENTE_DESTINO], [VCH_ESTADO]) VALUES (1002, N'F000007', CAST(0x0000A3AA00000000 AS DateTime), N'Jonathan Vidal Ore', N'Monica Landeo Aroni', CAST(30.00 AS Decimal(8, 2)), CAST(186.00 AS Decimal(8, 2)), CAST(33.48 AS Decimal(8, 2)), CAST(219.48 AS Decimal(8, 2)), N'www', N'MQAyADMA', NULL, 9, N'42770822', N'Cancelado', N'42770855', N'Registrado')
SET IDENTITY_INSERT [dbo].[TA_CARGA] OFF
INSERT [dbo].[TA_CLIENTE] ([VCH_DOCUMENTO], [VCH_NOMBRES], [VCH_APELLIDOS], [VCH_DIRECCION], [VCH_CORREO], [VCH_TELEFONO], [VCH_UBIGEO]) VALUES (N'42770822', N'Jonathan', N'Vidal Ore', NULL, NULL, NULL, NULL)
INSERT [dbo].[TA_CLIENTE] ([VCH_DOCUMENTO], [VCH_NOMBRES], [VCH_APELLIDOS], [VCH_DIRECCION], [VCH_CORREO], [VCH_TELEFONO], [VCH_UBIGEO]) VALUES (N'42770846', N'Jesus Amador', N'Paiva Dominguez', N'Jr El Misti 654', N'jpaivad@outlook.com', N'989237571', NULL)
INSERT [dbo].[TA_CLIENTE] ([VCH_DOCUMENTO], [VCH_NOMBRES], [VCH_APELLIDOS], [VCH_DIRECCION], [VCH_CORREO], [VCH_TELEFONO], [VCH_UBIGEO]) VALUES (N'42770855', N'Monica', N'Landeo Aroni', N'Jr Las Flores 7', NULL, NULL, NULL)
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (2, 1, N'TV Led', 2, 5, CAST(4.00 AS Decimal(8, 2)), CAST(50.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (2, 2, N'Documento', 2, 3, CAST(4.00 AS Decimal(8, 2)), CAST(120.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (3, 1, N'TV Led', 2, 3, CAST(3.00 AS Decimal(8, 2)), CAST(22.50 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (3, 3, N'Paquete Documento', 2, 3, CAST(3.00 AS Decimal(8, 2)), CAST(38.70 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (4, 1, N'TV Led', 2, 3, CAST(3.00 AS Decimal(8, 2)), CAST(22.50 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (4, 2, N'Documento', 2, 3, CAST(3.00 AS Decimal(8, 2)), CAST(90.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (5, 1, N'TV Led', 2, 2, CAST(20.00 AS Decimal(8, 2)), CAST(100.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (5, 3, N'Paquete Documento', 2, 1, CAST(10.00 AS Decimal(8, 2)), CAST(43.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (6, 1, N'TV Led', 2, 5, CAST(5.00 AS Decimal(8, 2)), CAST(62.50 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (6, 2, N'Documento', 2, 5, CAST(5.00 AS Decimal(8, 2)), CAST(250.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (1002, 1, N'TV Led', 2, 2, CAST(20.00 AS Decimal(8, 2)), CAST(100.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_DETALLECARGA] ([INT_CODIGO_CARGA], [INT_CODIGO_PRODUCTO], [VCH_DESCRIPCION], [INT_TIPO_CARGA], [INT_CANTIDAD], [DBL_PESO], [DBL_IMPORTE]) VALUES (1002, 3, N'Paquete Documento', 2, 2, CAST(10.00 AS Decimal(8, 2)), CAST(86.00 AS Decimal(8, 2)))
INSERT [dbo].[TA_PERSONA] ([INT_CODIGOPERSONA], [INT_CODIGOTIPODOCUMENTO], [VCH_NUMERODOCUMENTO], [VCH_APEPATPERSONA], [VCH_APEMATPERSONA], [VCH_NOMBREPERSONA], [DTE_FECHANACIMIENTO], [VCH_FOTO], [VCH_DIRECCION], [VCH_TELEFONO], [CHR_SEXOPERSONA], [INT_CODIGOCARGO], [VCH_CODIGO_UBIGEO], [BLN_ACTIVO]) VALUES (1, 1, N'42770846', N'Benites', N'Peña', N'Elvis', NULL, NULL, NULL, NULL, N'M', NULL, NULL, 1)
SET IDENTITY_INSERT [dbo].[TA_PRODUCTO] ON 

INSERT [dbo].[TA_PRODUCTO] ([INT_CODIGO_PRODUCTO], [VCH_NOMBRE], [VCH_DESCRIPCION], [DBL_PRECIO]) VALUES (1, N'TV Led', N'TV Led', CAST(2.50 AS Decimal(18, 2)))
INSERT [dbo].[TA_PRODUCTO] ([INT_CODIGO_PRODUCTO], [VCH_NOMBRE], [VCH_DESCRIPCION], [DBL_PRECIO]) VALUES (2, N'Documento', N'Documento', CAST(10.00 AS Decimal(18, 2)))
INSERT [dbo].[TA_PRODUCTO] ([INT_CODIGO_PRODUCTO], [VCH_NOMBRE], [VCH_DESCRIPCION], [DBL_PRECIO]) VALUES (3, N'Paquete Documento', N'Paquete Documento', CAST(4.30 AS Decimal(18, 2)))
SET IDENTITY_INSERT [dbo].[TA_PRODUCTO] OFF
SET IDENTITY_INSERT [dbo].[TA_PROGRAMACION_RUTA] ON 

INSERT [dbo].[TA_PROGRAMACION_RUTA] ([INT_CODIGO_PROGRAMACION_RUTA], [INT_CODIGO_RUTA], [DTM_FECHA_ORIGEN], [DTM_FECHA_DESTINO], [TIM_HORA_SALIDA], [TIM_HORA_LLEGADA], [INT_TIPO_SERVICIO], [INT_CODIGOVEHICULO], [INT_CODIGOPERSONA], [BLN_ESTADO]) VALUES (7, 4, CAST(0x0000A3A700000000 AS DateTime), CAST(0x0000A3A800000000 AS DateTime), CAST(0x070050CFDF960000 AS Time), CAST(0x070040230E430000 AS Time), 1, 2, 1, 1)
INSERT [dbo].[TA_PROGRAMACION_RUTA] ([INT_CODIGO_PROGRAMACION_RUTA], [INT_CODIGO_RUTA], [DTM_FECHA_ORIGEN], [DTM_FECHA_DESTINO], [TIM_HORA_SALIDA], [TIM_HORA_LLEGADA], [INT_TIPO_SERVICIO], [INT_CODIGOVEHICULO], [INT_CODIGOPERSONA], [BLN_ESTADO]) VALUES (8, 5, CAST(0x0000A3A700000000 AS DateTime), CAST(0x0000A3A800000000 AS DateTime), CAST(0x0700E03495640000 AS Time), CAST(0x0700E03495640000 AS Time), 1, 2, 1, 1)
INSERT [dbo].[TA_PROGRAMACION_RUTA] ([INT_CODIGO_PROGRAMACION_RUTA], [INT_CODIGO_RUTA], [DTM_FECHA_ORIGEN], [DTM_FECHA_DESTINO], [TIM_HORA_SALIDA], [TIM_HORA_LLEGADA], [INT_TIPO_SERVICIO], [INT_CODIGOVEHICULO], [INT_CODIGOPERSONA], [BLN_ESTADO]) VALUES (9, 6, CAST(0x0000A3A700000000 AS DateTime), CAST(0x0000A3A800000000 AS DateTime), CAST(0x0700E03495640000 AS Time), CAST(0x0700E03495640000 AS Time), 1, 2, 1, 1)
SET IDENTITY_INSERT [dbo].[TA_PROGRAMACION_RUTA] OFF
SET IDENTITY_INSERT [dbo].[TA_ROL] ON 

INSERT [dbo].[TA_ROL] ([INT_CODIGO_ROL], [VCH_NOMBRE]) VALUES (1, N'Counter')
INSERT [dbo].[TA_ROL] ([INT_CODIGO_ROL], [VCH_NOMBRE]) VALUES (2, N'Recepcionista')
INSERT [dbo].[TA_ROL] ([INT_CODIGO_ROL], [VCH_NOMBRE]) VALUES (3, N'Auxiliar Almacen')
SET IDENTITY_INSERT [dbo].[TA_ROL] OFF
SET IDENTITY_INSERT [dbo].[TA_RUTA] ON 

INSERT [dbo].[TA_RUTA] ([INT_CODIGO_RUTA], [INT_CODIGO_AGENCIAORIGEN], [INT_CODIGO_AGENCIADESTINO], [BLN_ESTADO]) VALUES (4, 3, 5, 1)
INSERT [dbo].[TA_RUTA] ([INT_CODIGO_RUTA], [INT_CODIGO_AGENCIAORIGEN], [INT_CODIGO_AGENCIADESTINO], [BLN_ESTADO]) VALUES (5, 3, 3, 1)
INSERT [dbo].[TA_RUTA] ([INT_CODIGO_RUTA], [INT_CODIGO_AGENCIAORIGEN], [INT_CODIGO_AGENCIADESTINO], [BLN_ESTADO]) VALUES (6, 3, 4, 1)
SET IDENTITY_INSERT [dbo].[TA_RUTA] OFF
SET IDENTITY_INSERT [dbo].[TA_TIPO_CARGA] ON 

INSERT [dbo].[TA_TIPO_CARGA] ([INT_TIPO_CARGA], [VCH_NOMBRE]) VALUES (1, N'Fragil')
INSERT [dbo].[TA_TIPO_CARGA] ([INT_TIPO_CARGA], [VCH_NOMBRE]) VALUES (2, N'Normal')
SET IDENTITY_INSERT [dbo].[TA_TIPO_CARGA] OFF
SET IDENTITY_INSERT [dbo].[TA_TIPO_SERVICIO] ON 

INSERT [dbo].[TA_TIPO_SERVICIO] ([INT_CODIGOTIPOSERVICIO], [VCH_NOMBRE]) VALUES (1, N'Express')
INSERT [dbo].[TA_TIPO_SERVICIO] ([INT_CODIGOTIPOSERVICIO], [VCH_NOMBRE]) VALUES (2, N'Normal')
SET IDENTITY_INSERT [dbo].[TA_TIPO_SERVICIO] OFF
SET IDENTITY_INSERT [dbo].[TA_TIPO_TRANSPORTE] ON 

INSERT [dbo].[TA_TIPO_TRANSPORTE] ([INT_TIPO_TRANSPORTE], [VCH_NOMBRE]) VALUES (1, N'Normal')
SET IDENTITY_INSERT [dbo].[TA_TIPO_TRANSPORTE] OFF
SET IDENTITY_INSERT [dbo].[TA_TIPOSDOCUMENTO] ON 

INSERT [dbo].[TA_TIPOSDOCUMENTO] ([INT_CODIGOTIPODOCUMENTO], [VCH_NOMBRE]) VALUES (1, N'DNI')
INSERT [dbo].[TA_TIPOSDOCUMENTO] ([INT_CODIGOTIPODOCUMENTO], [VCH_NOMBRE]) VALUES (2, N'RUC')
INSERT [dbo].[TA_TIPOSDOCUMENTO] ([INT_CODIGOTIPODOCUMENTO], [VCH_NOMBRE]) VALUES (3, N'PASAPORTE')
SET IDENTITY_INSERT [dbo].[TA_TIPOSDOCUMENTO] OFF
INSERT [dbo].[TA_UBIGEO] ([VCH_CODIGO_UBIGEO], [VCH_CODIGO_DEPARTAMENTO], [VCH_CODIGO_PROVINCIA], [VCH_CODIGO_DISTRITO]) VALUES (N'010101', N'01', N'01', N'01')
SET IDENTITY_INSERT [dbo].[TA_USUARIO] ON 

INSERT [dbo].[TA_USUARIO] ([INT_CODIGO_USUARIO], [VCH_USUARIO], [VCH_CLAVE], [INT_CODIGO_ROL], [INT_CODIGOPERSONA], [VCH_NOMBRES]) VALUES (1, N'shuaman', N'123', 1, NULL, N'Susan Huaman')
INSERT [dbo].[TA_USUARIO] ([INT_CODIGO_USUARIO], [VCH_USUARIO], [VCH_CLAVE], [INT_CODIGO_ROL], [INT_CODIGOPERSONA], [VCH_NOMBRES]) VALUES (2, N'jpaiva', N'222', 2, NULL, N'Jesus Paiva')
INSERT [dbo].[TA_USUARIO] ([INT_CODIGO_USUARIO], [VCH_USUARIO], [VCH_CLAVE], [INT_CODIGO_ROL], [INT_CODIGOPERSONA], [VCH_NOMBRES]) VALUES (3, N'epena', N'333', 3, NULL, N'Elvis Pena')
SET IDENTITY_INSERT [dbo].[TA_USUARIO] OFF
SET IDENTITY_INSERT [dbo].[TA_VEHICULO] ON 

INSERT [dbo].[TA_VEHICULO] ([INT_VEHICULO], [VCH_PLACA], [VCH_MARCA], [VCH_MODELO], [VCH_COLOR], [INT_TIPO_TRANSPORTE]) VALUES (2, N'B6D-206', N'Cherolet', N'Aveo', N'Gris', 1)
INSERT [dbo].[TA_VEHICULO] ([INT_VEHICULO], [VCH_PLACA], [VCH_MARCA], [VCH_MODELO], [VCH_COLOR], [INT_TIPO_TRANSPORTE]) VALUES (3, N'B6D-234', N'Mazda', N'3', N'Blanco', 1)
INSERT [dbo].[TA_VEHICULO] ([INT_VEHICULO], [VCH_PLACA], [VCH_MARCA], [VCH_MODELO], [VCH_COLOR], [INT_TIPO_TRANSPORTE]) VALUES (4, N'B6D-222', N'Kia', N'Rio', N'Negro', 1)
SET IDENTITY_INSERT [dbo].[TA_VEHICULO] OFF
...
GO
ALTER TABLE [dbo].[TA_DETALLECARGA]  WITH CHECK ADD  CONSTRAINT [FK_TA_DETALLECARGA_TA_PRODUCTO1] FOREIGN KEY([INT_CODIGO_PRODUCTO])
REFERENCES [dbo].[TA_PRODUCTO] ([INT_CODIGO_PRODUCTO])
GO
ALTER TABLE [dbo].[TA_DETALLECARGA] CHECK CONSTRAINT [FK_TA_DETALLECARGA_TA_PRODUCTO1]
GO
...
GO
ALTER TABLE [dbo].[TA_PERSONAS]  WITH CHECK ADD  CONSTRAINT [FK_dbo.TA_PERSONAS_dbo.TA_AREAS_INT_CODIGOAREA] FOREIGN KEY([INT_CODIGOAREA])
REFERENCES [dbo].[TA_AREAS] ([INT_CODIGOAREA])
GO
ALTER TABLE [dbo].[TA_PERSONAS] CHECK CONSTRAINT [FK_dbo.TA_PERSONAS_dbo.TA_AREAS_INT_CODIGOAREA]
GO
